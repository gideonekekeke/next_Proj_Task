...
const Header = () => {
	...
	useEffect(() => {
		if (sessionStorage.getItem("user")) {
			setGetSession(JSON.parse(sessionStorage.getItem("user")));
		}
	}, []);

	return (
		<header>
			<nav className='bg-white fixed w-[100%] z-50 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800'>
...
py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none 
...
01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z'
								...
								<svg
									...
									<path
										fill-rule='evenodd'
										d='M4.293 4.
293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 
